...
class data_Streaming(users_service.data_streamServicer,getData()):
    dataXYZ = None
    def __init__(self):
        self.dataXYZ = getData()
    def streaming(self, request, context):
        self.dataXYZ = np.transpose(self.dataXYZ)
        data_x = self.dataXYZ[0]
        data_y = self.dataXYZ[1]
        data_z = self.dataXYZ[2]

        data = user_messages.data
            (landmark_x1 = ,landmark_y1 = ,landmark_z1 = ,
...
def serve():
    ...
    users_service.add_data_streamServicer_to_server(data_Streaming(users_service.data_streamServicer,getData()), server)
